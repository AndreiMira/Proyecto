...
io.on("connection", (socket) => {
    ...
    socket.on("p1Choice", (data) => {
        ...
        socket
            ...
            .emit("p1Choice", { rpsValue: data.rpsValue });
    ...
    socket.on("p2Choice", (data) => {
        ...
        socket
            .to(data.roomUniqueId)
            .emit("p2Choice", { rpsValue: data.rpsValue });
...
function declareWinner(roomUniqueId) {
    ...
    if (p1Choice === p2Choice) {
        ...
        (p1Choice == "Rock" &&
            (p2Choice == "Scissor" || p2Choice == "Lizard")) ||
        (p1Choice == "Paper" && (p2Choice == "Rock" || p2Choice == "Spock")) ||
        (p1Choice == "Scissor" &&
            (p2Choice == "Paper" || p2Choice == "Lizard")) ||
        (p1Choice == "Lizard" &&
            (p2Choice == "Spock" || p2Choice == "Paper")) ||
        (p1Choice == "Spock" && (p2Choice == "Scissor" || p2Choice == "Rock"))
    ) {
        winner = "p1";
    } else {
        winner = "p2";
